...
| `PIVB_CONFIG` | 400/403 | config missing/invalid, unknown alias, or audience/target mismatch |
| `PIVB_UNAVAILABLE` | 503 | the daemon is not reachable on the signing socket |
